...
public interface SystemUserRoleMapper {
	 ...
	 * @return
	 */
    int deleteSystemUserRoleByUserId(Long userId);

	int batchInsertSystemUserRole(List<SystemUserRole> systemUserRoles);

    List<Long> selectSystemRoleByUserId(Long id);

    Integer checkSystemRoleByRoleId(Long roleId);

    int deleteSystemUserRoleByRoleId(Long roleId);
}
