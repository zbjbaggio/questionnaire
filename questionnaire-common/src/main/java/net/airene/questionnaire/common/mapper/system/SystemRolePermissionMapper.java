...
public interface SystemRolePermissionMapper {
    ...
    List<Long> selectPermissionIds(Long roleId);

    int deleteSystemRolePermissionByRoleId(Long roleId);

	/**
	 * 批量生成
	 * @param systemRolePermissions
	 * @return
	 */
	int batchInsertSystemRolePermission(List<SystemRolePermission> systemRolePermissions);
